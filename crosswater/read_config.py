...
def read_config(file_name_or_fobj):
    ...
    strahler_limit = config['preprocessing'].getint('strahler_limit',
                                                    fallback=None)
    ratio_herbicide_area_cal = config['catchment_model'].getfloat('ratio_herbicide_area_cal', fallback=None)
    ...
    res['catchment_model']['ratio_herbicide_area_cal'] = ratio_herbicide_area_cal
    return res
